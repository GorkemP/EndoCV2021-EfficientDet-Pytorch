...
set_name = "val"
image_folder_path = "../datasets/polyps_deneme/EndoCV_DATA1"
annotation1 = "../model_1/EndoCV_DATA1.json"
annotation2 = "../model_2/EndoCV_DATA1.json"
annotation3 = "../model_3/EndoCV_DATA1.json"
annotation4 = "../model_4/EndoCV_DATA1.json"

annotation_ensemble = "../ensemble_result/EndoCV_DATA1.json"
...
image_annotations4 = [x for x in annotations4["annotations"] if x["image_id"] == image_id]
