...
weights_file = "trained_weights/efficientdet-d" + str(efficientdet_version) + "_best_126.pth"
VAL_GT = '/home/ws2080/Desktop/data/EndoCV2021/edited_files/paper/Kvasir-SEG/kvasir_seg_COCO.json'
VAL_IMGS = "/home/ws2080/Desktop/data/EndoCV2021/edited_files/paper/Kvasir-SEG/images"
target_json_name = "test_kvasir_bbox_results_" + str(efficientdet_version) + ".json"
conf_threshold = 0.2
nms_threshold = 0.5
use_cuda = True
gpu = 0
