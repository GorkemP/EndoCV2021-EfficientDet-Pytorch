...
weights_file = "logs/birdview_vehicles/efficientdet-d0_best.pth"
nms_threshold = 0.5
...
ap.add_argument('--nms_threshold', type=float, default=nms_threshold, help='nms threshold, don\'t change it if not for testing purposes')
