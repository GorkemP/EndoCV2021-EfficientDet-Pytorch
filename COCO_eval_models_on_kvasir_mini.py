...
project_name = "polyps_paper_kvasir_3"
efficientdet_version = 3
weights_file = "trained_weights/efficientdet-d" + str(efficientdet_version) + "_best_115.pth"

# VAL_GT = '/home/ws2080/Desktop/data/EndoCV2021/edited_files/paper/Kvasir-SEG/kvasir_seg_test_COCO.json'
# VAL_IMGS = "/home/ws2080/Desktop/data/EndoCV2021/edited_files/paper/Kvasir-SEG/test"
# # target_json_name = "test_kvasir_test_bbox_results_" + str(efficientdet_version) + ".json"
# target_json_name = "test_kvasir_mini_test_bbox_results_" + str(efficientdet_version) + ".json"

VAL_GT = 'datasets/polyps_all_centers/annotations/instances_test.json'
VAL_IMGS = 'datasets/polyps_all_centers/test'
target_json_name = "test_kvasir_model_on_endocv_center_bbox_results_" + str(efficientdet_version) + ".json"
